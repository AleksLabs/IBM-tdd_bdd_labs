...
def step_impl(context):
    element = context.driver.find_element("id", "pet_category")
    element.clear()
...
def step_impl(context):
    element = context.driver.find_element("id", "search-btn")
    element.click()

@then('I should see the message "Success"')
def step_impl(context):
    element = context.driver.find_element("id", "flash_message")
    assert element.text == "Success"


@then('I should see "Fido" in the results')
def step_impl(context):
    element = context.driver.find_element("id", "search_results")
